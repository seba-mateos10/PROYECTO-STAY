export let products = [
  ...
  },
  {
    ...
    stock: 20,
    description:
      "Jersey de maxima calidad y dureza, todas las costuras reforzadas, no Destiñe, maxima calidad de estampados.",
  },
  {
    id: "3",
  ...
  },
  {
    ...
    stock: 30,
    description: "Tela friza premium, muy suave al tacto y super abrigado.",
  },
  {
    id: "5",
    title: "Air Force 1",
  ...
  },
  {
    ...
    stock: 30,
    description:
      "Las zapatillas Air Jordan Retro 4 son una versión retro de las icónicas Air Jordan 4 originales. Están diseñadas para replicar el diseño y la sensación de las zapatillas originales, pero con materiales y tecnologías actualizadas. Están hechas con cuero y malla de alta calidad y cuentan con la tecnología Air-Sole en la suela para brindar un gran confort y amortiguación.",
  },
];
